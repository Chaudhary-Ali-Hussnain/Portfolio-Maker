...
const Portfolio = () => {
  ...
  useEffect(() => {
    ...
    const updateScale = () => {
      ...
      setA4Scale(Math.min(1, vw / A4_WIDTH));
    };
    updateScale();
  ...
  const downloadPDF = async () => {
    ...
    const canvas = await html2canvas(el, { scale: 2, backgroundColor: "#ffffff", width: 794 });
  ...
  if (portfolioType === "ats") {
    return (
      <div className={styles.atsPage} style={{ overflow: "auto" }}>
  ...
  return (
    <div className={styles.portfolioPage} style={{ overflow: "auto", background: `linear-gradient(to bottom, ${s.bg}, ${s.secondary}, ${s.bg})` }}>
      <div style={{ width: "794px", margin: "0 auto", transform: a4Scale < 1 ? "scale(" + a4Scale + ")" : "none", transformOrigin: "top center" }}>
          <div className={styles.portfolioBox} id="portfolioBox" style={{ background: "#fff", width: "100%" }}>
